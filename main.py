...
GOOGLE_API_KEY = "AIzaSyAKM9FhaakxUookPHEpFA_mLCpTp0tJAaA"
os.environ["GOOGLE_API_KEY"] = GOOGLE_API_KEY  

class BagDetectionProcessor:
    def __init__(self, video_file, yolo_model_path="best.pt"):
        """Initialize bag detection processor for conveyor belt monitoring."""
    ...
    def analyze_image_with_gemini(self, image_path):
        """Analyze the bag image using Gemini AI."""
        try:
    ...
    def process_crop_image(self, image, track_id):
        """Save and analyze cropped bag images."""
    ...
    def crop_and_process(self, frame, box, track_id):
        """Crop and process detected bags."""
    ...
    def process_video_frame(self, frame):
        """Process each video frame to detect and analyze bags."""
...
if __name__ == "__main__":
    video_file = "bag.mp4"  # Ensure this is the correct file
